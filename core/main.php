...
class core {
	...
	public static function shutdownHandler($error) {
		// $e = error_get_last();
		...
		$errorTemplate = $path_app.'/page500.php';
		if (!is_file($errorTemplate)) {
			$errorTemplate = 'core/layouts/page500.php';
		}
	...
	public static function run($config) {
		...
		try {
			...
			self::$path_app = trimLeft(str_replace('\\', '/', getcwd()), self::$path_root.'/');
			...
			// throw new Exception('test error', E_WARNING);
